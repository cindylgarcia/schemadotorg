...
class AddressItem extends FieldItemBase implements AddressInterface {
  ...
  public static function generateSampleValue(FieldDefinitionInterface $field_definition) {
    ...
    $properties = $field_definition->getSetting('fields') ?: array_keys(LabelHelper::getGenericFieldLabels());
    $fields = [];
    foreach ($properties as $property) {
      if ($field = FieldHelper::getPropertyName($property)) {
        $fields[] = $field;
      }
    }

    $random_address_values = [
    ...
    foreach ($fields as $field) {
      $random_address[$field] = $random_address_values[$field];
    }
