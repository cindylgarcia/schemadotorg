...
abstract class FlexFieldTypeBase extends PluginBase implements FlexFieldTypeInterface {
   ...
   * {@inheritdoc}
   */
  public function getWidgetSetting($name) {
    return isset($this->widget_settings[$name]) ? $this->widget_settings[$name] : static::defaultWidgetSettings()[$name];
  }

  /**
   * {@inheritdoc}
   */
  public function getFormatterSetting($name) {
    return isset($this->formatter_settings[$name]) ? $this->formatter_settings[$name] : static::defaultFormatterSettings()[$name];
  }
